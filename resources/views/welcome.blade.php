...
<body class="bg-[#F4F7FF] min-h-screen flex flex-col items-center justify-center p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
        ...
        <a href="{{ route('login.siswa') }}" class="group bg-white p-10 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-transparent hover:border-blue-100 transition-all duration-300 flex flex-col items-center text-center">
            <div class="text-[#0066FF] mb-5 group-hover:scale-110 transition-transform duration-300">
